...
urlpatterns = [
    ...
    path("bid_submit/<int:listingid>",views.bidsubmit,name="bidsubmit"),
    path("comment_submit/<int:listingid>",views.cmntsubmit,name="cmntsubmit"),
    ...
    path("close_bid/<int:listingid>",views.closebid,name="closebid"),
    path("yourwinnings",views.yourwinnings,name="yourwinnings")
]
